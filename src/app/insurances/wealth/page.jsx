...
const GeneralInsurance = () => {
  ...
  return (
    <div className="w-full h-auto p-10 xxs:p-2">
      ...
      <div>
      <div className="bg-white w-full  lg:h-[150vh] desktop2xl:h-[100vh] xxs:h-[125vh] desktopxl:h-[120vh] xs:h-[120vh]  rounded-2xl xxs:flex-col lg:flex-row  flex shadow-lg border border-slate-300 ">
