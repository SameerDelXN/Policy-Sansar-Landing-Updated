...
>
  <h1 className="lg:text-4xl xxs:text-xl">
    <span className="lg:text-5xl font-bold xxs:text-2xl">G</span>roup Insurance
  </h1>
  ...
  Group insurance provides financial protection for employees or members of an organization against various risks, including health issues, accidents, and other emergencies. It ensures that individuals within the group have access to essential coverage, promoting well-being and financial stability for the entire group.</p>
        ...
        <div className="flex flex-col gap-5 lg:p-8 xxs:p-4 w-full">
          <div className="flex flex-col items-start gap-3">
            <h1 className="lg:text-2xl font-semibold  xxs:text-sm ">Types of <span className="text-blue-700">Group</span> Insurance</h1>
            <hr className="w-64"/>
            ...
            <div className="w-full flex flex-wrap items-center justify-evenly">
              <div className="flex flex-col items-center gap-2">
               ...
               <h1 className="text-lg font-bold xxs:text-sm">Life</h1>
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                />
               <div className="flex flex-col items-center ">
               <h1 className="text-lg font-bold xxs:text-sm">Health</h1>
               <p className="text-sm text-slate-500 xxs:text-xs">Insurance</p>
               </div>
              </div>
              <div className="flex flex-col items-center gap-2">
                ...
                />
               <div className="flex flex-col items-center ">
               <h1 className="text-lg font-bold xxs:text-sm">Accident</h1>
               <p className="text-sm text-slate-500 xxs:text-xs">Insurance</p>
               </div>
              </div>
              <div className="flex flex-col items-center gap-2">
                ...
                />
               <div className="flex flex-col items-center ">
               <h1 className="text-lg font-bold xxs:text-sm">Term-Life</h1>
               <p className="text-sm text-slate-500 xxs:text-xs">Insurance</p>
               </div>
              </div>
            </div>
          ...
          <div className="flex flex-col items-start gap-3 ">
            <h1 className="lg:text-2xl font-bold xxs:text-sm">Top Features of <span className="text-blue-700">Group</span> Insurance</h1>
            <hr className="w-64"/>
            ...
            <div className="w-full flex flex-wrap items-center justify-center  gap-3 ">
              <div className="lg:w-72 xl:w-64 desktop2xl:w-72 bg-white rounded-2xl hover:shadow-md hover:rounded-2xl hover:border hover:border-slate-200 lg:h-80 flex flex-col items-center justify-center gap-3 p-3 transition-all ease-in duration-300 xs:w-40 xs:h-56 xxs:w-36 xxs:h-48 xxs:shadow-md xxs:border xxs:border-slate-100">
                  ...
                  />
                  <h1 className="lg:text-2xl text-center xxs:text-sm">Comprehensive Coverage</h1>
                  <p className="lg:text-sm text-center text-slate-500 xxs:text-xs">Provides life, health, or accident coverage to a group under a single policy.</p>
              </div>
              <div className="lg:w-72 xl:w-64 desktop2xl:w-72 bg-white rounded-2xl hover:shadow-md hover:rounded-2xl hover:border hover:border-slate-200 lg:h-80 flex flex-col items-center justify-center gap-3 p-3 transition-all ease-in duration-300 xs:w-40 xs:h-56  xxs:w-36 xxs:h-48 xxs:shadow-md xxs:border xxs:border-slate-100">
                  <Image
                    ...
                    className="xxs:w-12 xxs:h-12 lg:w-20 lg:h-20"
                  />
                  <h1 className="lg:text-2xl text-center xxs:text-sm">Cost-Effective Premiums</h1>
                  <p className="text-center lg:text-sm text-slate-500 xxs:text-xs">Offers lower premiums compared to individual policies due to group pooling.</p>
              </div>
              <div className="lg:w-72 xl:w-64 desktop2xl:w-72 bg-white rounded-2xl hover:shadow-md hover:rounded-2xl hover:border hover:border-slate-200 lg:h-80 flex flex-col items-center justify-center gap-3 p-3 transition-all ease-in duration-300 xs:w-40 xs:h-56 xxs:w-36 xxs:h-48 xxs:shadow-md xxs:border xxs:border-slate-100">
                  <Image
                    src={CustomizedIcon}
                    ...
                    className="xxs:w-12 xxs:h-12 lg:w-20 lg:h-20"
                  />
                  <h1 className="lg:text-2xl text-center xxs:text-sm ">Customizable Plans</h1>
                  <p className="text-center lg:text-sm text-slate-500 xxs:text-xs">Tailored benefits based on the specific needs of the group or organization.</p>
              </div>
              <div className="lg:w-72 xl:w-64 desktop2xl:w-72 bg-white rounded-2xl hover:shadow-md hover:rounded-2xl hover:border hover:border-slate-200 lg:h-80 flex flex-col items-center justify-center gap-3 p-3 transition-all ease-in duration-300 xs:w-40 xs:h-56 xxs:w-36 xxs:h-48 xxs:shadow-md xxs:border xxs:border-slate-100">
                  <Image
                    src={SimpleIcon}
                    ...
                    className="xxs:w-12 xxs:h-12 lg:w-20 lg:h-20"
                  />
                  <h1 className="lg:text-2xl text-center xxs:text-sm">Simplified Enrollment</h1>
                  <p className="text-center lg:text-sm text-slate-500 xxs:text-xs">Easy onboarding with minimal paperwork and eligibility criteria.</p>
              </div>
            </div>
          </div>
        </div>
