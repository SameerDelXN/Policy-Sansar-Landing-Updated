...
>
  <h1 className="text-4xl">
    <span className="text-5xl font-bold">G</span>roup Insurance
  </h1>
  <p className="w-2/3">
  Group Insurance offers specialized Kisan Credit Card Holder Group Term Life coverage in District Central Co-operative Banks, helping rural communities safeguard their financial future. For corporates, we provide Employer-Employee Life Term Plans to ensure that both employers and their employees are well-protected, fostering a secure work environment.  </p>
</div>

          <div className="w-1/2  flex flex-col  justify-evenly">
          <div className="flex flex-col gap-5 p-8">
          <div className="flex flex-col items-start gap-3">
            <h1 className="text-2xl font-bold">Types of <span className="text-blue-700">Group</span> Insurance</h1>
            <hr className="w-64"/>
            ...
            <div className="w-full flex flex-wrap items-center justify-evenly">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                />
               <div className="flex flex-col items-center ">
               <h1 className="text-lg font-bold">Term-Life</h1>
               <p className="text-sm text-slate-500">Insurance</p>
               </div>
              </div>
            </div>
          ...
          <div className="flex flex-col items-start gap-3 ">
            <h1 className="text-2xl font-bold">Top Features of <span className="text-blue-700">Group</span> Insurance</h1>
            <hr className="w-64"/>
            ...
            <div className="w-full flex flex-wrap items-center justify-center gap-3 ">
              <div className="w-72 bg-white rounded-2xl hover:shadow-md hover:rounded-2xl hover:border hover:border-slate-200 h-80 flex flex-col items-center justify-center gap-3 p-3 transition-all ease-in duration-300">
                  ...
                  />
                  <h1 className="text-3xl text-center ">Corporate Health Plans</h1>
                  <p className="text-center text-slate-500">Compare corporate health insurance plans for businesses.</p>
              </div>
              <div className="w-72 bg-white rounded-2xl hover:shadow-md hover:rounded-2xl hover:border hover:border-slate-200 h-80 flex flex-col items-center justify-center gap-3 p-3 transition-all ease-in duration-300">
                  <Image
                    ...
                    alt="Instant Policy Icon"
                  />
                  <h1 className="text-3xl text-center ">Employee Life Coverage</h1>
                  <p className="text-center text-slate-500">Provide group life insurance for employees with options to customize coverage.</p>
              </div>
              <div className="w-72 bg-white rounded-2xl hover:shadow-md hover:rounded-2xl hover:border hover:border-slate-200 h-80 flex flex-col items-center justify-center gap-3 p-3 transition-all ease-in duration-300">
                  <Image
                    src={supportIcon}
                    ...
                    alt="Instant Policy Icon"
                  />
                  <h1 className="text-3xl text-center ">Premium Management</h1>
                  <p className="text-center text-slate-500">Allow employers to manage premium payments and renewals for group policies.</p>
              </div>
              <div className="w-72 bg-white rounded-2xl hover:shadow-md hover:rounded-2xl hover:border hover:border-slate-200 h-80 flex flex-col items-center justify-center gap-3 p-3 transition-all ease-in duration-300">
                  <Image
                    ...
                    alt="Instant Policy Icon"
                  />
                  <h1 className="text-3xl text-center ">Wellness Benefits</h1>
                  <p className="text-center text-slate-500">Offer wellness incentives and coverage for employee health initiatives.</p>
              </div>
            </div>
          </div>
