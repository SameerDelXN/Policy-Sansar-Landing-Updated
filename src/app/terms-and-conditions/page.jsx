...
const page = () => {
  ...
  <p className="text-justify leading-relaxed text-gray-700 ">
    In the Site, Riskfree Life provides users with access to information primarily about Financial and Insurance products and services, 
  ...
  <p className="text-justify leading-relaxed text-gray-700 mt-4 g:text-md">
    ...
    purchasing the Service(s) that you have selected. You hereby agree that Riskfree Life may contact you either electronically or through 
  ...
  <p className="text-justify leading-relaxed text-gray-700 mt-4">
    You also agree that Riskfree Life reserves the right to make your details available to its affiliates and partners, and you may be 
    ...
    promotional materials and/or special offers from Riskfree Life through email or SMS.
  </p>
</div>
...
<div className="lg:px-4 lg:py-6 xxs:px-2 xxs:py-3 ">
  ...
  <p className=" text-justify leading-relaxed text-gray-700">
    Riskfree Life grants you a limited license to access and make personal use of the Site and the Service. This license does not include any 
    ...
    (in Riskfree Life's sole discretion) an unreasonable or disproportionately large load on Riskfree Life's infrastructure; or any use of 
    data mining, robots, or similar data gathering and extraction tools. You may not bypass any measures used by Riskfree Life to prevent 
    or restrict access to the Site. Any unauthorized use by you shall terminate the permission or license granted to you by Riskfree Life. 
    ...
    <li>
      ...
      <h1 className="lg:text-2xl font-semibold mb-4 xxs:text-lg">3. Eligibility</h1>
        <p className="text-justify leading-relaxed text-gray-700">
          ...
          users suspended or removed from the system by Riskfree Life for any
       ...
       <h1 className="lg:text-2xl font-semibold mb-4 xxs:text-lg">4. Your Account</h1>
        <p className="text-justify leading-relaxed text-gray-700">
          ...
          untrue, inaccurate, not current or incomplete), or Riskfree Life has
          reasonable grounds to suspect that such information is untrue,
          inaccurate, not current or incomplete, Riskfree Life has the right to
          ...
          notify Riskfree Life immediately of any unauthorized use of your
          account or any other breach of security. Riskfree Life reserves the
       ...
       <h1 className="text-2xl font-semibold">5. Submitted Content</h1>
        <p className="text-justify leading-relaxed text-gray-700">
          Riskfree Life does not claim ownership of any materials you make
          available through the Site. At Riskfree Life's sole discretion, such
          ...
          available for inclusion on the Site, you grant Riskfree Life a
       ...
       <h1 className="lg:text-2xl font-semibold mb-4 xxs:text-lg">
        ...
        <p className="text-justify leading-relaxed text-gray-700">
          ...
          made under an incorrect price. Riskfree Life makes no representation
          ...
          IS" without warranty of any kind. Riskfree Life disclaims all
          warranties and conditions that this site, its services or any email
          sent from Riskfree Life, its affiliates, and/or their respective or
          associated service providers are free of viruses or other harmful
          components. Riskfree Life hereby disclaims all warranties and
          ...
          are independent affiliates and Riskfree Life are not liable for the
          ...
          therefore. Riskfree Life and its affiliates have no liability and will
          ...
          any government or authority. In no event shall Riskfree Life and/or
          ...
          otherwise, and even if Riskfree Life and/or its affiliates their
       ...
       <h1 className="lg:text-2xl font-semibold mb-4 xxs:text-lg">
        ...
        <p className="text-justify leading-relaxed text-gray-700">
          ...
          regulations laid down by the IRDAI. You understand that Riskfree Life
...
<p className="text-justify leading-relaxed text-gray-700">
  (v) You authorize the Riskfree Life/insurance Broking company to share information pertaining to your proposal including the medical records of the insured/proposer for the sole purpose of underwriting the proposal and/or claims settlement and with any Governmental and/or Regulatory authority.
</p>
<p className="text-justify leading-relaxed text-gray-700">
...
<ul className="list-disc pl-5">
  ...
  <li>Any person making default in complying with the provision of this section shall be liable for a penalty which may extend to ten lakh rupees.</li>
       ...
       <h1 className="lg:text-2xl font-semibold mb-4 xxs:text-lg">10. License Disclaimer</h1>
        <p className="text-justify leading-relaxed text-gray-700">
          Nothing on any Riskfree Life website shall be construed as conferring
          any license under any of Riskfree Life's or any third party's
       ...
       <h1 className="lg:text-2xl font-semibold mb-4 xxs:text-lg">11. Local Laws</h1>
        <p className="text-justify leading-relaxed text-gray-700">
          Riskfree Life controls and operates this Website from its headquarters
       ...
       <h1 className="lg:text-2xl font-semibold mb-4 xxs:text-lg">12. Limitation of Liability</h1>
        <p className="text-justify leading-relaxed text-gray-700">
          You expressly understand and agree that Riskfree Life and its
          ...
          or other intangible losses (even if Riskfree Life has been advised of
          ...
          Riskfree Life or its Affiliates are found liable for any loss or
          damage which arises out of or in any way connected with any of the
          occurrences described above, then the liability of Riskfree Life
          and/or Its Affiliates will in no event exceed, in the aggregate, the
          greater of (a) the service fees you paid to Riskfree Life in
          ...
          the benefit of Riskfree Life, Its affiliates, and/or their respective
          service providers.
        </p>
       </div>
       <div className="lg:px-4 lg:py-6 xxs:px-2 xxs:py-3 ">
       <h1 className="lg:text-2xl font-semibold mb-4 xxs:text-lg">13. Indemnity</h1>
        <p className="text-justify leading-relaxed text-gray-700">
          You agree to indemnify and hold Riskfree Life (and its officers,
       ...
       <h1 className="lg:text-2xl font-semibold mb-4 xxs:text-lg">14. Electronic Communication</h1>
        <p className="text-justify leading-relaxed text-gray-700">
          When you use the Site or send emails to Riskfree Life, you are
          communicating with Riskfree Life electronically. You consent to
          receive communications from Riskfree Life electronically. Riskfree
